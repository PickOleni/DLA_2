namespace DLA_MODEL_2
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //HoleCheck(field, length, wide, numberZero);
        ...
        {
            //if (field[i--, j] != 1 || field[i++, j] != 1 || field[i, j--] != 1 ||
            //    field[i--, j--] != 1 || field[i++, j--] != 1 || field[i--, j++] != 1 || field[i++, j++] != 1
            //    || field[i, j++] != 1)
            //{

            //    Move(field, i, j);
            //}
            //else if (field[i--, j] == 1 || field[i++, j] == 1 || field[i, j--] == 1 ||
            //         field[i--, j--] == 1 || field[i++, j--] == 1 || field[i--, j++] == 1
